...
var os = require('os');
var companyDomainName = '.corp.ebay.com';
var hostname = os.hostname() + companyDomainName;
...
Launcher.prototype = {
    ...
    fork: function() {
        ...
        env.BROWSER_REFRESH_URL = (secure ? 'https' : 'http') + '://' + hostname + ':' + port + '/browser-refresh.js';
